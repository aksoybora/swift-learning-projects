...
//  TravelBook
//
//  Created by Bora Aksoy on 28.12.2024.
//
...
class ListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    //Title ve Id verileri CoreData'dan alıp dizilere ekleyen fonksiyon. TableView içine gelecek olan satırlar için gerekli.
    @objc func getData() {
